/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /builds/vendor/sb_linbot03_vendor_trunk/build/vendor/xulrunner-1.9.2/mozilla/dom/interfaces/svg/nsIDOMSVGForeignObjectElem.idl
 */
