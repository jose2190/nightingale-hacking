/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /builds/vendor/sb_linbot03_vendor_trunk/build/vendor/xulrunner-1.9.2/mozilla/toolkit/components/search/nsIBrowserSearchService.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsISearchEngine : public nsISupports {
 public: 
  ...
  /**
   * XXX Songbird extension
   * A string containing a space delimited set of keywords describing this search engine
   */
...
/* readonly attribute AString tags; */
NS_IMETHODIMP nsSearchEngine::GetTags(nsAString & aTags)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
